...
// On page load: set default dates based on current company year start year (from PHP variable)
(function() {
...
function validateBillingTillDate() {
    ...
    if (invoiceDateStr && billingDateStr) {
        ...
        if (billingDate > invoiceDate) {
            showDateError("billing_till_date", "Billing date cannot be after Invoice date");
            return false;
        }
    }
...
// Add this code where you handle date validations
