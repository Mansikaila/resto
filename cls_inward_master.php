...
{   
     ...
     public function pageSearch()
    {
        ...
        $sql="CAll csms1_search('t.inward_no, t.inward_no, t2.customer_name, t.inward_no, t.inward_no, t2.customer_name, t3.customer_name, t.billing_starts_from, t.unloading_charge, t.sp_note, t.total_qty, t.total_wt, t.weigh_bridge_slip_no, t.gross_wt, t.tare_wt, t.net_wt, t.vehicle_no, t.driver_name, t.driver_mobile_no, t.transporter, t.other_expense1, t.other_expense2, t.created_date, t.modified_date, t.inward_id','tbl_inward_master t INNER JOIN tbl_customer_master t2 ON t.customer=t2.customer_id INNER JOIN tbl_customer_master t3 ON t.broker=t3.customer_id')";
        echo "
        ...
        <thead>
            ...
            <th> Inward No <br><input type=\"text\" data-index=\"1\" placeholder=\"Search Inward No\" /></th> 
                         <th> Customer <br><input type=\"text\" data-index=\"2\" placeholder=\"Search Customer\" /></th> 
                         <th> Broker <br><input type=\"text\" data-index=\"3\" placeholder=\"Search Broker\" /></th> 
                         <th> Billing Starts From <br><input type=\"text\" data-index=\"4\" placeholder=\"Search Billing Starts From\" /></th> 
                         <th> Unloading Charge <br><input type=\"text\" data-index=\"5\" placeholder=\"Search Unloading Charge\" /></th> 
                         <th> Sp Note <br><input type=\"text\" data-index=\"6\" placeholder=\"Search Sp Note\" /></th> 
                         <th> Total Qty <br><input type=\"text\" data-index=\"7\" placeholder=\"Search Total Qty\" /></th> 
                         <th> Total Wt <br><input type=\"text\" data-index=\"8\" placeholder=\"Search Total Wt\" /></th> 
                         <th> Weigh Bridge Slip No <br><input type=\"text\" data-index=\"9\" placeholder=\"Search Weigh Bridge Slip No\" /></th> 
                         <th> Gross Wt <br><input type=\"text\" data-index=\"10\" placeholder=\"Search Gross Wt\" /></th> 
                         <th> Tare Wt <br><input type=\"text\" data-index=\"11\" placeholder=\"Search Tare Wt\" /></th> 
                         <th> Net Wt <br><input type=\"text\" data-index=\"12\" placeholder=\"Search Net Wt\" /></th> 
                         <th> Vehicle No <br><input type=\"text\" data-index=\"13\" placeholder=\"Search Vehicle No\" /></th> 
                         <th> Driver Name <br><input type=\"text\" data-index=\"14\" placeholder=\"Search Driver Name\" /></th> 
                         <th> Driver Mobile No <br><input type=\"text\" data-index=\"15\" placeholder=\"Search Driver Mobile No\" /></th> 
                         <th> Transporter <br><input type=\"text\" data-index=\"16\" placeholder=\"Search Transporter\" /></th> 
                         <th> Other Expense1 <br><input type=\"text\" data-index=\"17\" placeholder=\"Search Other Expense1\" /></th> 
                         <th> Other Expense2 <br><input type=\"text\" data-index=\"18\" placeholder=\"Search Other Expense2\" /></th> 
                         <th> Created Date <br><input type=\"text\" data-index=\"20\" placeholder=\"Search Created Date\" /></th> 
                         <th> Modified Date <br><input type=\"text\" data-index=\"22\" placeholder=\"Search Modified Date\" /></th> 
                         </tr>
        </thead>
        <tbody>";
         $_grid="";
        ...
        $fieldvalue=$_rs["inward_no"];
                       ...
                       $fieldvalue=$_rs["total_wt"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["weigh_bridge_slip_no"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       ...
                       $fieldvalue=$_rs["tare_wt"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["net_wt"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["vehicle_no"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["driver_name"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["driver_mobile_no"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["transporter"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["other_expense1"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
                       $fieldvalue=$_rs["other_expense2"];
                            $_grid.= "
                            <td> ".$fieldvalue." </td>"; 
