...
if ($fields_names[$i] == "item_id") {
    ...
    $field_str .= '<div id="gridContainer" class="table-responsive mt-3" style="display:none;">';
$field_str .= '    <div class="row">';
$field_str .= '        <div class="col-12">';
$field_str .= '            <!-- Grid content here -->';
$field_str .= '        </div>';
$field_str .= '    </div>';
$field_str .= '</div>';
