    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateDates() {
            ...
            if (dropdown.value === "Forward") {
                // Forward logic: Start from 01/04/currentYear to 31/03/(currentYear+1)
                startDateInput.value = `${currentYear}-04-01`; // 1st April of the current year
                endDateInput.value = `${currentYear + 1}-03-31`; // 31st March of the next year
            } else if (dropdown.value === "Reverse") {
                // Reverse logic: Start from 01/04/(currentYear-1) to 31/03/currentYear
                startDateInput.value = `${currentYear - 1}-04-01`; // 1st April of the previous year
                endDateInput.value = `${currentYear}-03-31`; // 31st March of the current year
            } else {
                // Clear dates if no value is selected
