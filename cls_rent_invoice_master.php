...
public function fillModel($_mdl)
{
    ...
    if (!empty($_rs)) {
        ...
        // Debug: Verify rent_invoice_id
        error_log("Filled rent_invoice_id: " . $_mdl->_rent_invoice_id);
    } else {
        error_log("No master record found for rent_invoice_id: " . $_REQUEST["rent_invoice_id"]);
    }
}
}
